...
def process_activity_data(file_path):
    # Step 1: Load Data
    ...
    output_filename = 'preprocessed_activity_data.csv'
...
# Example usage
activity_file_path = 'C:/Users/Jyothesh karnam/Desktop/Trail/TrailActivity.csv'
process_activity_data(activity_file_path)
